const data = [
  {
    title: "Пробки, очереди и духота. Что ждет алматинский аэропорт",
    link: "https://tengrinews.kz/article//article/probki-ocheredi-i-duhota-chto-jdet-almatinskiy-aeroport-2409/",
    image_src: "/userdata/article/2024/article_2409/thumb_b/photo_3507.jpeg",
    description:
      "Казахстанцы продолжают жаловаться на алматинский аэропорт. Гости и жители мегаполиса обращают внимание на хаос, пробки, духоту в терминале,",
  },
  {
    title:
      '"Я будто в космос слетал". Интервью с судмедэкспертом по делу Бишимбаева',
    link: "https://tengrinews.kz/article//article/ya-v-kosmos-sletal-intervyu-sudmedekspertom-delu-bishimbaeva-2416/",
    image_src: "/userdata/article/2024/article_2416/thumb_b/photo_3516.jpeg",
    description:
      "Алматинский судебно-медицинский эксперт Тахир Халимназаров внезапно стал объектом повышенного внимания после одного судебного заседания по делу",
  },
  {
    title:
      '"А ведь была проделана такая работа". В пригороде Петропавловска дома ушли под воду',
    link: "https://tengrinews.kz/article//article/a-byila-prodelana-takaya-rabota-prigorode-petropavlovska-2418/",
    image_src: "/userdata/article/2024/article_2418/thumb_b/photo_3518.jpeg",
    description:
      "Некоторые пригородные села Петропавловска продолжает топить паводками. Местные жители как могут стараются спасти нажитое имущество, домашних",
  },
  {
    title:
      '"Такого никогда не было". Петропавловск больше 10 часов без питьевой воды',
    link: "https://tengrinews.kz/article//article/takogo-ne-byilo-petropavlovsk-10-chasov-pitevoy-vodyi-2417/",
    image_src: "/userdata/article/2024/article_2417/thumb_b/photo_3515.jpeg",
    description:
      "Самый северный областной центр Казахстана остался без питьевой воды. В Петропавловске из кранов ничего не бежит больше 10 часов. Аким города",
  },
  // {
  //   title:
